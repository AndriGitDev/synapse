...
export const securityAuditSession: AgentSession = {
  ...
  events: [
    ...
    },
    {
      ...
      type: 'decision',
      content: '🚨 CRITICAL: Found hardcoded JWT secret in auth route. This should be in environment variables.',
      parentId: 's5',
    },
    {
      id: 's7',
    ...
    },
    {
      ...
      type: 'decision',
      content: '🚨 HIGH: SQL injection vulnerability at line 45. Query uses string interpolation: `SELECT * FROM users WHERE id = ${userId}`',
      parentId: 's8',
    },
    {
      id: 's10',
    ...
    },
    {
      ...
      type: 'decision',
      content: '⚠️ MEDIUM: Admin route lacks rate limiting. Vulnerable to brute force attacks.',
      parentId: 's10',
    },
    {
      id: 's12',
    ...
    },
    {
      ...
      type: 'decision',
      content: '⚠️ MEDIUM: User input not sanitized before rendering. Potential XSS via name field.',
      parentId: 's12',
    },
    {
      id: 's14',
    ...
    },
    {
      ...
      type: 'decision',
      content: '🚨 HIGH: Real API keys committed in .env.example. These need immediate rotation.',
      parentId: 's15',
    },
    {
      id: 's17',
